...
namespace Everest{
    ...
    enum Joystick {
        ...
        J_8  = GLFW_JOYSTICK_8 ,
        J_9  = GLFW_JOYSTICK_9 ,
        J_10 = GLFW_JOYSTICK_10,
        J_11 = GLFW_JOYSTICK_11,
        J_12 = GLFW_JOYSTICK_12,
        J_13 = GLFW_JOYSTICK_13,
        J_14 = GLFW_JOYSTICK_14,
        J_15 = GLFW_JOYSTICK_15,
        J_16 = GLFW_JOYSTICK_16,
    };
    ...
    enum JoystickHat {
        ...
        JH_down               = 4,
        JH_left               = 8,
        JH_right_up           = (GLFW_HAT_RIGHT | GLFW_HAT_UP),
        JH_right_down         = (GLFW_HAT_RIGHT | GLFW_HAT_DOWN),
        JH_left_up            = (GLFW_HAT_LEFT  | GLFW_HAT_UP),
        JH_left_down          = (GLFW_HAT_LEFT  | GLFW_HAT_DOWN),
    };
    ...
    enum Gamepad {
        ...
        G_dpad_up             = GLFW_GAMEPAD_BUTTON_DPAD_UP,
        G_dpad_right          = GLFW_GAMEPAD_BUTTON_DPAD_RIGHT,
        G_dpad_down           = GLFW_GAMEPAD_BUTTON_DPAD_DOWN,
        G_dpad_left           = GLFW_GAMEPAD_BUTTON_DPAD_LEFT,
        G_last                = GLFW_GAMEPAD_BUTTON_LAST,

        G_cross               = GLFW_GAMEPAD_BUTTON_A,
        G_circle              = GLFW_GAMEPAD_BUTTON_B,
        G_square              = GLFW_GAMEPAD_BUTTON_X,
        G_triangle            = GLFW_GAMEPAD_BUTTON_Y,
